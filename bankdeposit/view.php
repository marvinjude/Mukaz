                  ...
                  <tbody>
                     <?php foreach ($data as $row ): ?>
                      ...
                      <td><?= $row['id']?></td>
                        ...
                        <td>
                        <button class="btn btn-secondary btn-sm delete-bank-deposit" bank-deposit-id = <?= $row['id']?> > 
    ...
    <script type="text/javascript">
      $('document').ready(function(){
       $(function () {
        ...
        $('.delete-bank-deposit').click(function(){
           let bankDepositId = $(this).attr('bank-deposit-id');
           window.location = "delete.php?bd_id=" + bankDepositId;
        })
